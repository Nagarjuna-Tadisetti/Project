...
@NgModule({
  declarations: [
    AppComponent,AppLogin,AppStudent,AppRegister,Activities, Attendance, Homeworks, PersonalDetails, Progress, SchoolDetails, AppLoginTeacher, AppRegisterTeacher
  ],
  imports: [
